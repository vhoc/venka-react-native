    ...
    <View style={styles.container}>
      ...
      <MainView>

        {
          isLoading, usuario ? (
            <>
              <GlobalVentaTotal idUsuario={usuario.id} selectedDate={ new Date( '2022-02-14' ) } selectedDateLimit={ new Date( '2022-02-20' ) } title='venta total' helpText={`Texto de ayuda de venta total`} icon='money-bill' width='100%'/>
